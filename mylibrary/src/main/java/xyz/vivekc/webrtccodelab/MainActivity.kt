...
class MainActivity : AppCompatActivity(), SignalingInterface {
...
//        rootEglBase = EglBase.create()
    ...
    private fun getIceServers() {
        ...
        Utils.getInstance()?.getRetrofitInstance()?.getIceCandidates()?.enqueue(object : Callback<TurnServerModel?> {
